...
final StyleData progressBarStyle = StyleData({
  ...
  'progress-bar-medium-text-font-family': 'text-subtitle-1-font-family',
  'progress-bar-medium-text-font-weight': 'text-subtitle-1-font-weight',
  'progress-bar-medium-text-font-size': 'text-subtitle-1-font-size',
  'progress-bar-large-text-font-family': 'text-subtitle-1-font-family',
  'progress-bar-large-text-font-weight': 'text-subtitle-1-font-weight',
  'progress-bar-large-text-font-size': 'text-subtitle-1-font-size',
  'progress-bar-giant-text-font-family': 'text-subtitle-1-font-family',
  'progress-bar-giant-text-font-weight': 'text-subtitle-1-font-weight',
  'progress-bar-giant-text-font-size': 'text-subtitle-1-font-size',
