...
final StyleData textFieldStyle = StyleData({
  ...
  'text-field-medium-text-font-family': 'text-subtitle-2-font-family',
  'text-field-medium-text-font-size': 'text-subtitle-2-font-size',
  'text-field-medium-text-font-weight': 'text-subtitle-2-font-weight',
